...
function Hero() {
  return (
    <div className="text-white mt-15 flex flex-col justify-center md:flex-row md:justify-between w-full pb-5 border-b   ">
      ...
      className="w-[60%]  ">
        ...
        <div className="pt-4 flex gap-5 border-b pb-10">
          <button className="bg-white rounded-xl px-3 py-1 flex gap-1 text-black items-center">
            <span className="size-4"><FaArrowRight className="w-full h-full size-2 "/></span>
            <span>View Work</span>
          </button>
           <button className="bg-white/30 rounded-xl px-3 py-1 flex gap-1 text-black">
            <span className="text-lg"><CiMail className="w-full h-full "/></span>
            <span>hello@sakshikanwar.dev</span>
          </button>
        </div>
        <div className="flex justify-between mx-3 items-center mt-4 pb-10">
          <div className="flex gap-2 ">
            <span className="mt-2 text"><CiLocationOn className="w-full h-full"></CiLocationOn></span>
            <div className="flex-col flex">
              <span className="text-">Based in New Delhi</span>
              <span className="text-sm text-gray-500">open to remote work </span>
            </div>
            
          </div>
          <div className="flex gap-2 ">
            <span className="mt-2 text"><FaMicrochip className="w-full h-full"></FaMicrochip></span>
            <div className="flex-col flex">
              <span className="text">AI Systems + frontend </span>
              <span className="text-sm text-gray-500">RAG, agents, benchmarks </span>
            </div>
            
          </div>
          <div className="flex gap-2 ">
            <span className="mt-2 text"><FaCheck className="w-full h-full"></FaCheck></span>
            <div className="flex-col flex">
              <span className="text">Currently Available</span>
      ...
      <div className="flex flex-col justify-center w-[35%]  ">
        <motion.div initial={{
         ...
         className="relative w-full">
          <img
           src={photo} alt=""  className="rounded-xl"/>
